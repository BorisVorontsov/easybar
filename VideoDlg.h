...
#define VWM_UPDATEASPECTRATIO	WM_APP + 0x00000800 //wParam: 0, lParam: 0, return: *
#define VWM_SAVENORMALSTATE		WM_APP + 0x00000810 //wParam: 0, lParam: 0, return: *
#define VWM_CHANGESTATE			WM_APP + 0x00000820 //wParam: VWS_%, lParam: 0, return: *
