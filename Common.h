...
SIZE_T GetOpenDialog(HINSTANCE hInstance, HWND hWnd, LPCWSTR lpTitle, LPWSTR lpFileName,
					SIZE_T szFNSize, LPCWSTR lpFilter, DWORD dwFilterIndex, BOOL bMultiSelect = FALSE,
					LPCWSTR lpInitialDir = NULL);
SIZE_T GetSaveDialog(HINSTANCE hInstance, HWND hWnd, LPCWSTR lpTitle, LPWSTR lpFileName,
					SIZE_T szFNSize, LPCWSTR lpFilter, LPDWORD pFilterIndex, LPCWSTR lpDefExt,
					LPCWSTR lpInitialDir = NULL);
SIZE_T GetOpenDialog_Vista(HINSTANCE hInstance, HWND hWnd, LPCWSTR lpTitle, LPWSTR lpFileName,
						  SIZE_T szFNSize, LPCWSTR lpFilter, DWORD dwFilterIndex, BOOL bMultiSelect = FALSE,
						  LPCWSTR lpInitialDir = NULL);
SIZE_T GetSaveDialog_Vista(HINSTANCE hInstance, HWND hWnd, LPCWSTR lpTitle, LPWSTR lpFileName,
						  SIZE_T szFNSize, LPCWSTR lpFilter, LPDWORD pFilterIndex, LPCWSTR lpDefExt,
						  LPCWSTR lpInitialDir = NULL);
