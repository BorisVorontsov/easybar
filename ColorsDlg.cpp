	...
	switch (uMsg)
	{
		case WM_INITDIALOG:
		{
			...
			for (UINT i = 0; i < 8/*dwClrsCnt*/; i++)
				pOldColors[i] = (COLORREF)SendDlgItemMessage(hWnd, IDC_CBOITEMS, CB_GETITEMDATA, i, 0);
			//--------------------------------------------------------------------
		...
		case WM_COMMAND:
			switch (LOWORD(wParam))
			{
				case IDC_CBOITEMS:
				{
					...
					{
						int intSelItem = (int)SendDlgItemMessage(hWnd, IDC_CBOITEMS, CB_GETCURSEL, 0, 0);
						crSelColor = (COLORREF)SendDlgItemMessage(hWnd, IDC_CBOITEMS, CB_GETITEMDATA, intSelItem, 0);
...
{
	dwBackgroundColor = (DWORD)SendDlgItemMessage(hColorsWnd, IDC_CBOITEMS, CB_GETITEMDATA, 0, 0);
	dwGradientColor1 = (DWORD)SendDlgItemMessage(hColorsWnd, IDC_CBOITEMS, CB_GETITEMDATA, 1, 0);
	dwGradientColor2 = (DWORD)SendDlgItemMessage(hColorsWnd, IDC_CBOITEMS, CB_GETITEMDATA, 2, 0);
	dwBorderColor1 = (DWORD)SendDlgItemMessage(hColorsWnd, IDC_CBOITEMS, CB_GETITEMDATA, 3, 0);
	dwBorderColor2 = (DWORD)SendDlgItemMessage(hColorsWnd, IDC_CBOITEMS, CB_GETITEMDATA, 4, 0);
	dwTextColor = (DWORD)SendDlgItemMessage(hColorsWnd, IDC_CBOITEMS, CB_GETITEMDATA, 5, 0);
	dwTextShadowColor = (DWORD)SendDlgItemMessage(hColorsWnd, IDC_CBOITEMS, CB_GETITEMDATA, 6, 0);
	dwActiveItemTextColor = (DWORD)SendDlgItemMessage(hColorsWnd, IDC_CBOITEMS, CB_GETITEMDATA, 7, 0);
}
